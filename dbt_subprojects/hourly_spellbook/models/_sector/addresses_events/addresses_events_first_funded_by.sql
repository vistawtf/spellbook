...
(
    ...
    post_hook='{{ expose_spells(\'["arbitrum", "avalanche_c", "bnb", "ethereum", "fantom", "gnosis", "optimism", "polygon", "celo", "zora", "base", "scroll", "zksync", "sei", "mantle", "blast", "ronin", "nova", "abstract", "apechain"]\',
                                    "sector",
                                    "addresses_events",
                                    \'["hildobby", "0xr3x"]\') }}'
)
